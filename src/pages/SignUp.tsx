          ...
          <Card className="border-0 shadow-xl">
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">
                Enter your information to create your SignScribe account
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <div className="text-center text-sm">
                ...
                <Link to="/signin" className="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 font-medium">
                  Sign in
                </Link>
              </div>
